        ...
        <div className="bg-white border border-slate-100 rounded-3xl shadow-xl shadow-slate-200/50 p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 mt-2 max-w-sm mx-auto">
              Choose a strong new password. Make sure it's at least 6 characters long.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 pr-12 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all font-semibold"
