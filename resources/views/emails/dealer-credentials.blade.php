...
<head>
    ...
    <title>Your Dealer Account Credentials</title>
</head>
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 35px 35px 15px;">
                            ...
                            <p style="color: #555; margin: 0; font-size: 15px; line-height: 1.7;">
                                Your dealer account has been successfully created by the admin team.
                                Below are your login credentials to access the Dealer Portal.
                            </p>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding: 25px 30px;">
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding: 8px 0; color: #777; font-size: 14px; width: 100px;">Email:</td>
                                                <td style="padding: 8px 0; color: #1a1a2e; font-size: 15px; font-weight: 600;">
                                                    {{ $dealerEmail }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; color: #777; font-size: 14px; width: 100px;">Password:</td>
                                                <td style="padding: 8px 0; color: #1a1a2e; font-size: 15px; font-weight: 600;">
                                                    {{ $dealerPassword }}
                                                </td>
                                            </tr>
                    ...
                    <tr>
                        <td style="padding: 0 35px 30px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #fff8e1; border-radius: 8px; border-left: 4px solid #ffc107;">
                                <tr>
                                    <td style="padding: 15px 20px;">
                                        <p style="color: #856404; margin: 0; font-size: 13px; line-height: 1.6;">
                                            <strong>⚠️ Security Notice:</strong> We recommend changing your password after your first login for security purposes. Keep your credentials confidential and do not share them with anyone.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background-color: #f8f9fb; padding: 25px 35px; text-align: center; border-top: 1px solid #eee;">
                            <p style="color: #999; margin: 0 0 5px; font-size: 13px;">
                                This is an automated message from {{ config('app.name') }}.
                            </p>
                            <p style="color: #bbb; margin: 0; font-size: 12px;">
