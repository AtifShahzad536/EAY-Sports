...
<head>
    ...
    <title>B2B Wholesale Invoice #B2B-{{ $order->id }}</title>
    <!-- Google Fonts: Outfit -->
    ...
    <div class="invoice-container">
        ...
        <div class="invoice-header">
            <div class="company-branding">
                ...
                <div>
                    ...
                    <div class="company-details">
                        Elite Athletic Apparel & B2B Wholesales Portal<br>
            ...
            <div class="invoice-meta">
                ...
                <div class="meta-item">Order ID: <strong>#B2B-{{ $order->id }}</strong></div>
        ...
        <div class="info-section">
            <div class="info-col">
                <h3 class="info-heading">Bill To / B2B Partner</h3>
                <div class="info-name">{{ $order->dealer ? $order->dealer->name : 'Wholesale Partner' }}</div>
                <div class="info-text">
                    Email: {{ $order->dealer ? $order->dealer->email : 'N/A' }}<br>
                    Phone: {{ $order->dealer ? $order->dealer->phone ?: 'N/A' : 'N/A' }}
                </div>
            </div>
        ...
        <div class="bottom-section">
            <div class="notes-col">
                ...
                @if($order->notes)
                    <div class="notes-title">B2B Special Custom Requests</div>
            ...
            <div class="totals-col">
                <div class="total-row">
                    ...
                    <strong>{{ $order->items->sum('qty') }} units</strong>
                </div>
                <div class="total-row">
                    <span>Subtotal:</span>
        ...
        <div class="signature-section">
            ...
            <div>
                <div class="signature-line"></div>
                Accepted By (Wholesale Partner Signature)
            </div>
        </div>
    </div>
    ...
    <script>
        (function() {
            ...
            function init3DPreview(item, side) {
                ...
                controls.enableRotate = false; // Static for print layout stability
                ...
                loader.load(item.url, function(gltf) {
                    ...
                    // Add Decals to the Submeshes (just like in show.blade.php)
